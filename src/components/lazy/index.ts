...
export const LazyTransactionList = lazy(() => import('../transactions/TransactionList'));
export const LazyTransactionForm = lazy(() => import('../transactions/TransactionForm'));
export const LazyCategoryManager = lazy(() => import('../categories/CategoryManager'));
export const LazyMonthlyReport = lazy(() => import('../reports/MonthlyReport'));
export const LazyCategoryReport = lazy(() => import('../reports/CategoryReport'));
