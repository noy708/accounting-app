...
describe('progressSlice', () => {
  ...
  it('should handle updateProgress', () => {
    const stateWithOperation = progressReducer(
      initialState,
      startOperation({
        id: 'test-op',
        name: 'Test Operation',
  ...
  it('should handle startDataLoad', () => {
    ...
    expect(actual.operations['load-transactions'].name).toBe(
  ...
  it('should handle startDataSave', () => {
    ...
    expect(actual.operations['save-transaction-create'].name).toBe(
      'create transaction'
    );
    expect(actual.operations['save-transaction-create'].indeterminate).toBe(
      false
    );
    expect(actual.operations['save-transaction-create'].estimatedDuration).toBe(
      2000
    );
  });
