...
import { Transaction, CreateTransactionDto, UpdateTransactionDto, TransactionFilter, LoadingState, PaginationState } from '../../types';
...
const transactionSlice = createSlice({
  ...
  reducers: {
    // Loading states
    setTransactionLoading: (state, action: PayloadAction<{ isLoading: boolean; operation?: string }>) => {
