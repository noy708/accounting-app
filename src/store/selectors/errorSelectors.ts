...
export const selectNotifications = (state: RootState) => state.errors.notifications;
...
export const selectValidationErrors = createSelector(
  [selectErrors],
  (errors) => errors.filter((e: any) => e.type === 'validation')
);

export const selectRetryableErrors = createSelector(
  [selectErrors],
  (errors) => errors.filter((e: any) => e.retryable)
);

export const selectErrorsByField = (field: string) =>
  createSelector(
    [selectValidationErrors],
    (validationErrors) => validationErrors.filter((e: any) => e.field === field)
  );
